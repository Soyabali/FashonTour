import 'package:fashiontour/dresslist.dart';
...
class _DetailInfoState extends State<DetailInfo> with SingleTickerProviderStateMixin
{
          ...
          Padding(
            ...
            child: TabBar(
              ...
              tabs: <Widget>[
                ...
                Tab(child: Text('Coats',style: TextStyle(fontSize: 17.0,
                    fontFamily: 'Montserrat',
                    fontWeight: FontWeight.bold
                ),),),
                Tab(child: Text('Jacket',style: TextStyle(fontSize: 17.0,
                    fontFamily: 'Montserrat',
                    fontWeight: FontWeight.bold
                ),),),
                Tab(child: Text('Blazers',style: TextStyle(fontSize: 17.0,
                    fontFamily: 'Montserrat',
                    fontWeight: FontWeight.bold
                ),),),
                Tab(child: Text('Dresses',style: TextStyle(fontSize: 17.0,
                    fontFamily: 'Montserrat',
                    fontWeight: FontWeight.bold
                ),),),
              ],
